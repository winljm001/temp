      ...
      children: [
        {
          ...
          menuName: '活动方案',
          menuScope: 'operate',
          component: 'distribution/menu1/menu1-1'
        },
        {
          upMenuCode: '10050000',
          children: [],
          ...
          menuName: '活动方案',
          menuScope: 'operate',
          component: 'distribution/menu1/menu1-2'
        },
        {
          upMenuCode: '10050000',
          children: [],
          ...
          menuName: '活动方案',
          menuScope: 'operate',
          component: 'distribution/menu1/menu1-3'
        }
      ],
      menuCode: '10050100',
      menuIcon: 'paper-clip',
      ...
      children: [
        {
          ...
          menuName: '活动方案',
          menuScope: 'operate',
          component: 'distribution/menu2/menu2-1'
        },
        {
          upMenuCode: '10050200',
          children: [],
          ...
          menuName: '活动方案',
          menuScope: 'operate',
          component: 'distribution/menu2/menu2-2'
        },
        {
          upMenuCode: '10050200',
          children: [],
          ...
          menuName: '活动方案',
          menuScope: 'operate',
          component: 'distribution/menu2/menu2-3'
        }
      ],
